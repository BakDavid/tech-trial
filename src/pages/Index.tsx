  ...
  const features = [
    {
      ...
      description: "Curated IT interview questions covering all major topics"
    },
    {
      icon: TrendingUp,
    ...
    },
    {
      ...
      description: "Data Structures, Algorithms, System Design, and Web Development"
    },
    {
      icon: Users,
      title: "Practice Mode",
      description: "Randomized questions to test your knowledge effectively"
    }
  ];
        ...
        <div className="text-center space-y-8 animate-fade-in">
          <div className="space-y-4">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Practice with curated interview questions, track your progress, and ace your next tech interview with confidence.
            </p>
          </div>
